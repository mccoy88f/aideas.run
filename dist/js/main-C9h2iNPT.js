...
var x=Object.defineProperty;var z=(s,e,t)=>e in s?x(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var y=(s,e,t)=>z(s,typeof e!="symbol"?e+"":e,t);import{D as M}from"./vendor-Cc5w31rP.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const T="modulepreload",R=function(s){return"/"+s},v={},b=function(e,t,r){let i=Promise.resolve();if(t&&t.length>0){let d=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");i=d(t.map(c=>{if(c=R(c),c in v)return;v[c]=!0;const u=c.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":T,u||(p.as="script"),p.crossOrigin="",p.href=c,l&&p.setAttribute("nonce",l),document.head.appendChild(p),u)return new Promise((f,g)=>{p.addEventListener("load",f),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return i.then(n=>{for(const l of n||[])l.status==="rejected"&&o(l.reason);return e().catch(o)})},D=["🚀","⚡","🎯","💡","🔧","📱","💻","🌐","🎮","📚","🎨","🎵","📷","📹","🎬","📺","📻","🎙️","🎤","🎧","🏠","🏢","🏪","🏨","🏥","🏫","🏛️","⛪","🕌","🕍","🚗","🚕","🚙","🚌","🚎","🏎️","🚓","🚑","🚒","🚐","🍕","🍔","🍟","🌭","🍿","🧂","🥨","🥯","🥖","🧀","⚽","🏀","🏈","⚾","🎾","🏐","🏉","🎱","🏓","🏸","🎪","🎭","🎨","🎬","🎤","🎧","🎼","🎹","🥁","🎷","🌍","🌎","🌏","🌐","🗺️","🗾","🧭","🏔️","⛰️","🌋","💎","🔮","🎁","🎈","🎉","🎊","🎋","🎍","🎎","🎏","🔮","🧿","⚗️","🔭","📡","💻","🖥️","🖨️","⌨️","🖱️","📱","📲","💾","💿","📀","🎥","📺","📻","📷","📹"],k=s=>{const e={produttività:["⚡","🚀","💡","🔧","📊","📈","✅","🎯"],intrattenimento:["🎮","🎬","🎵","🎨","🎪","🎭","🎤","🎧"],sviluppo:["💻","🔧","⚙️","🔨","📱","🌐","🚀","⚡"],social:["👥","💬","📱","🌐","📞","📧","💌","📢"],utility:["🔧","⚙️","🛠️","📋","📝","📌","📍","🔍"],altro:["❓","💭","💡","🎯","⭐","💫","✨","🌟"]},t=s?.toLowerCase()||"altro",r=e[t]||e.altro;return r[Math.floor(Math.random()*r.length)]},B={GITHUB:{BASE:"https://api.github.com"},GOOGLE:{DRIVE:"https://www.googleapis.com/drive/v3",AUTH:"https://accounts.google.com/o/oauth2/v2/auth",TOKEN:"https://oauth2.googleapis.com/token"}},F={GITHUB_URL:/github\.com\/([^\/]+)\/([^\/]+)/,GITHUB_PAGES:/([^\.]+)\.github\.io\/([^\/]+)/};let O=0;function E(s,e="info",t=4e3,r={}){const i=document.getElementById("toast-container");if(!i){console.warn("Toast container non trovato");return}const o=`toast-${++O}`,n=document.createElement("div");n.id=o,n.className=`toast toast-${e}`,n.setAttribute("role","alert"),n.setAttribute("aria-live","polite");const l={success:`<svg viewBox="0 0 24 24" fill="currentColor">
  ...
  `;const d=n.querySelector(".toast-close"),c=n.querySelector(".toast-action"),u=()=>{n.classList.add("toast-removing"),setTimeout(()=>{n.parentNode&&n.parentNode.removeChild(n)},300)};return d.addEventListener("click",u),c&&r.onAction&&c.addEventListener("click",()=>{r.onAction(),u()}),i.appendChild(n),requestAnimationFrame(()=>{n.classList.add("toast-show")}),t>0&&setTimeout(u,t),o}function C(s){const e=document.createElement("div");return e.textContent=s,e.innerHTML}function q(s="id"){return`${s}-${Math.random().toString(36).substr(2,9)}-${Date.now()}`}function $(s={}){return new Promise(e=>{const{title:t="Conferma",message:r="Sei sicuro di voler continuare?",icon:i="question",confirmText:o="Conferma",cancelText:n="Annulla",type:l="default"}=s,d=document.createElement("div");d.className="confirm-popup";const c={question:`<svg viewBox="0 0 24 24" fill="currentColor" class="confirm-popup-icon">
      ...
      </svg>`},u=c[i]||c.question,m=l==="danger"?"confirm-popup-btn-danger":"confirm-popup-btn-primary";d.innerHTML=`
