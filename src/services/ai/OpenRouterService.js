  ...
  async getAvailableModels() {
    ...
    try {
      ...
      const categorizedModels = {
        '⭐ Testati e consigliati': [],
        '🆓 Modelli Gratuiti': [],
        '💎 Modelli Premium': []
      };

      // Aggiungi DeepSeek R1 come predefinito nella categoria consigliati
      const recommendedModels = [
        {
          value: 'deepseek/deepseek-r1:free',
          label: 'DeepSeek R1 (free)',
          description: 'Modello DeepSeek ottimizzato per performance e qualità',
      ...
      // Aggiungi i modelli consigliati
      recommendedModels.forEach(model => {
        categorizedModels['⭐ Testati e consigliati'].push(model);
      });
